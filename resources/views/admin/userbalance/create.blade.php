...
{!! Form::open(array('route' => config('quickadmin.route').'.userbalance.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('main_balance', old('main_balance'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('escrow_balance', 'Escrow Balance*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('escrow_balance', old('escrow_balance'), array('class'=>'form-control')) !!}
