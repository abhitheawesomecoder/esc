...
{!! Form::open(array('route' => config('quickadmin.route').'.withdrawalrequest.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

<div class="form-group">
    {!! Form::label('gateway_name', 'Gateway Name*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('gateway_name', old('gateway_name'), array('class'=>'form-control')) !!}
